...
from core.random_generators import seed_provider
from core.util_functions import ensure_non_existing_dir
...
class Container(object):
    ...
    def load_from_db(container_name):
        ...
        with open(config_file, "r") as config_h:
            ...
            for gen_type, gen_id in db.list_generators(namespace=container_name):
