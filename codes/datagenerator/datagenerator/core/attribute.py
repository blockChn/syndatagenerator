import pandas as pd
import logging
from core.operations import SideEffectOnly
    ...
    def __init__(self,
        ...
        if population.size == 0:
            ...
            if not ((init_values is None) ^ (init_gen is None)):
                ...
                init_values = init_gen.lookup("SQL condition")

                init_values = init_gen.generate(size=population.size) #this have gen values in column
