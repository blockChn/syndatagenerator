...
from core.operations import AddColumns
from core.random_generators import DependentGenerator
from core.util_functions import latest_date_before


class Clock(object):
    """
    A Clock is the central object managing the evolution of time of the whole container.
