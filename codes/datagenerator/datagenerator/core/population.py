...
from core.operations import AddColumns, SideEffectOnly
from core.relationship import Relationship
from core.attribute import Attribute
from core.util_functions import make_random_assign, ensure_non_existing_dir, is_sequence
from core import random_generators


class Population(object):
    def __init__(self, container, ids_gen=None, size=None, ids=None):
        """
    ...
    def create_relationship(self, name, seed=None):
        ...
        self.relationships[name] = Relationship(
            seed=seed if seed else next(self.container.seeder))
    ...
    def create_stock_relationship(self, name, item_id_gen, n_items_per_member):
        ...
        assigned_items = make_random_assign(
            ...
            set2=self.ids,
            seed=next(self.container.seeder))
    ...
    def load_from(folder, container):
        ...
        population = Population(container=container, size=0)
    ...
    class PopulationOps(object):
        ...
        def select_one(self, named_as, weight_attribute_name=None):
            ...
            gen = random_generators.NumpyRandomGenerator(
                ...
                p=p,
                seed=next(self.population.container.seeder))
