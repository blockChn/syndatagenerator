...
from components.time_patterns.profilers import DefaultDailyTimerGenerator
from components.social_networks.erdos_renyi import WithErdosRenyi

util_functions.setup_logging()

class Calling_scenario(WithErdosRenyi, Container):
